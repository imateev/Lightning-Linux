...
#if defined(CONFIG_AURALIC_MINI) || defined(CONFIG_AURALIC_ALTAIR) || defined(CONFIG_AURALIC_POLARIS) ||  defined(CONFIG_AURALIC_ARIES_G2) ||  defined(CONFIG_AURALIC_VEGA_G2)
	if(AURALIC_SATA_ID == sdp->host->auralic_id)
    {   // sata
