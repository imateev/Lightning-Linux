...
struct sdma_engine {
	...
	struct clk			*clk_ipg;
	struct clk			*clk_ahb;
	raw_spinlock_t			channel_0_lock;//hyf
	u32				script_number;
	struct sdma_script_start_addrs	*script_addrs;
		...
		u32 address)
{
	...
	raw_spin_lock_irqsave(&sdma->channel_0_lock, flags);//hyf
	...
	raw_spin_unlock_irqrestore(&sdma->channel_0_lock, flags);//hyf
...
static int sdma_probe(struct platform_device *pdev)
{
	...
	raw_spin_lock_init(&sdma->channel_0_lock);//hyf
