...
static int ksz9031rn_phy_fixup(struct phy_device *dev)
{
	 ...
	 */
	//mmd_write_reg(dev, 2, 4, 0x0077);
	//mmd_write_reg(dev, 2, 5, 0x7777);
	//mmd_write_reg(dev, 2, 6, 0x7777);
	//mmd_write_reg(dev, 2, 8, 0x01ef);

	mmd_write_reg(dev, 2, 4, 0x0000);
	mmd_write_reg(dev, 2, 5, 0x0000);
